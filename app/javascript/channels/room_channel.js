  ...
  consumer.subscriptions.create("RoomChannel", {
    ...
    received(data) {
      ...
      if(userId === data.id)
      {
       ...
       `<div class="m-1 p-1 ms-auto" style="background-color: white; border-radius: 10px;max-width:250px;">
        <p>
      ...
      {
        messageElement.innerHTML=
      ` <div class="m-1 p-1" style="background-color: white; border-radius: 10px;max-width:250px;">
       <p>
...
chatForm.addEventListener('submit', function (e) {
  ...
  consumer.subscriptions.subscriptions[0].perform('send_message', { message: message,id: userId })

class NotificationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @notification.save
        format.html { redirect_to notifications_url, notice: "Notification has been sent." }
  ...
  private
    ...
    def notification_params
      params.require(:notification).permit(:user_id, :content, :status, :task_id, :tool_id, :requester_id)
    end
end

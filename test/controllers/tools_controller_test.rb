...
class ToolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tool" do
    assert_difference("Tool.count") do
      post tools_url, params: { tool: { cost: @tool.cost, fromdate: @tool.fromdate, no_tools: @tool.no_tools, todate: @tool.todate, toolname: @tool.toolname, user_id: @tool.user_id } }
    end
  ...
  test "should update tool" do
    patch tool_url(@tool), params: { tool: { cost: @tool.cost, fromdate: @tool.fromdate, no_tools: @tool.no_tools, todate: @tool.todate, toolname: @tool.toolname, user_id: @tool.user_id } }

...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference("Info.count") do
      post infos_url, params: { info: { location: @info.location, news: @info.news, title: @info.title } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { location: @info.location, news: @info.news, title: @info.title } }

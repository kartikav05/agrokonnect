...
class CropsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crop" do
    assert_difference("Crop.count") do
      post crops_url, params: { crop: { cost: @crop.cost, location: @crop.location, name: @crop.name, user_id: @crop.user_id, weight: @crop.weight } }
    end
  ...
  test "should update crop" do
    patch crop_url(@crop), params: { crop: { cost: @crop.cost, location: @crop.location, name: @crop.name, user_id: @crop.user_id, weight: @crop.weight } }
